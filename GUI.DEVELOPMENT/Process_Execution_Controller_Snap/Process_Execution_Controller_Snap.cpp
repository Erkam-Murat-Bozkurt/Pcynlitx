...
void Process_Execution_Controller_Snap::Control_Executable_File_Name(){
...
void Process_Execution_Controller_Snap::ShowProgress(){
...
void Process_Execution_Controller_Snap::Process_End(int exit_status){
...
void Process_Execution_Controller_Snap::Print_Construction_Process_Output(){
...
void Process_Execution_Controller_Snap::Show_Descriptions(wxString Descriptor_File_Path){
...
void Process_Execution_Controller_Snap::Print_Text(wxString std_out, wxString title){
...
void Process_Execution_Controller_Snap::Print_Output_Stream(wxString title){
...
wxString Process_Execution_Controller_Snap::Get_Construction_Point(){

    return this->Construction_Point;
}

void Process_Execution_Controller_Snap::Receive_Descriptor_File_Path(wxString File_Path){
