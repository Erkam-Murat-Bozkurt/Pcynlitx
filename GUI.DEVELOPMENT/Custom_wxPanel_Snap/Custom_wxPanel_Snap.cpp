...
Custom_wxPanel_Snap::Custom_wxPanel_Snap(wxWindow * parent, wxWindowID id,
...
Custom_wxPanel_Snap::~Custom_wxPanel_Snap()
{
...
void Custom_wxPanel_Snap::Initialize_Sizer()
{
...
void Custom_wxPanel_Snap::DrawBackground(wxDC& dc, wxWindow *  wnd, const wxRect& rect)
{
...
void Custom_wxPanel_Snap::PaintNow(wxWindow * wnd)
{
     wxClientDC dc(wnd);
