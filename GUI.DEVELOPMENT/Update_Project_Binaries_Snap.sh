...
sudo mv MT_Project_Builder /snap/pcynlitx/current/usr/bin
...
sudo mv Descriptor_File_Reader /snap/pcynlitx/current/usr/bin
...
sudo mv Empty_Process_Descriptor_File_Builder /snap/pcynlitx/current/usr/bin
...
sudo mv Description_Recorder /snap/pcynlitx/current/usr/bin
...
sudo mv Pcynlitx_Kernel /snap/pcynlitx/current/usr/bin
...
sudo mv Description_Printer /snap/pcynlitx/current/usr/bin
