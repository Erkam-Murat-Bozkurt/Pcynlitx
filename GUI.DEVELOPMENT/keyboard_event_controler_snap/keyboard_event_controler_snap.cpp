...
keyboard_event_controler_snap::keyboard_event_controler_snap(){
...
void keyboard_event_controler_snap::Receive_Book_Manager(Custom_Notebook_Snap * Pointer){

     this->NB_Manager_Pointer = Pointer;
}

void keyboard_event_controler_snap::Undo_Redo_Actions(wxStyledTextCtrl * text_ctrl, wxKeyEvent & event){
...
void keyboard_event_controler_snap::Tab_Indentation(wxStyledTextCtrl * text_ctrl, wxKeyEvent & event){
...
void keyboard_event_controler_snap::Auto_Indentation(wxStyledTextEvent & event, wxStyledTextCtrl * text_ctrl){
...
bool keyboard_event_controler_snap::Check_Is_Line_Empty(wxString line_string){
...
bool keyboard_event_controler_snap::Check_Is_Caret_At_Start(wxStyledTextCtrl * text_ctrl, int line_number){
...
int keyboard_event_controler_snap::Get_Line_Indentation(wxStyledTextCtrl * text_ctrl, int line_number){
