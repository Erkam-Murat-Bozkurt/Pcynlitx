...
Intro_Page_Loader_Snap::Intro_Page_Loader_Snap(wxWindow * parent,wxSize page_size, int tab_ctrl_hgt):

                   wxWindow(parent,-1,wxDefaultPosition,page_size,wxBORDER_NONE)
{
     this->Connect(this->GetId(),wxEVT_PAINT,wxPaintEventHandler(Intro_Page_Loader_Snap::OnPaint));
...
Intro_Page_Loader_Snap::~Intro_Page_Loader_Snap(){
...
void Intro_Page_Loader_Snap::Clear_Dynamic_Memory(){
...
void Intro_Page_Loader_Snap::Receive_Intro_Page_Open_Status(bool * status)
{
     this->Intro_Page_Open_Status_Pointer = status;
}

void Intro_Page_Loader_Snap::Close_Intro_Page()
{
     this->~Intro_Page_Loader_Snap();
}


void Intro_Page_Loader_Snap::OnPaint(wxPaintEvent& event)
{
     event.Skip(false);
...
void Intro_Page_Loader_Snap::DrawBackground(wxDC& dc, wxWindow *  wnd, const wxRect & rect)
{
