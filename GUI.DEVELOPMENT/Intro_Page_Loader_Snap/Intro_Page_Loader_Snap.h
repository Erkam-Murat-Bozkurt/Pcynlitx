...
#ifndef INTRO_PAGE_LOADER_SNAP_H
#define INTRO_PAGE_LOADER_SNAP_H
...
{
public:
  Intro_Page_Loader_Snap(wxWindow * parent, wxSize page_size, int tab_ctrl_height);

  Intro_Page_Loader_Snap(const Intro_Page_Loader_Snap & orig);

  virtual ~Intro_Page_Loader_Snap();
...
#endif /* INTRO_PAGE_LOADER_SNAP_H */
