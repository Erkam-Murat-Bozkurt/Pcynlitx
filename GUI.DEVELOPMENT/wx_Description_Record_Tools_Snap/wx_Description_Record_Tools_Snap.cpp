...
void wx_Description_Record_Tools_Snap::Receive_NoteBook_Manager(Custom_Notebook_Snap * Pointer){

     this->NB_Manager_Pointer = Pointer;
}

void wx_Description_Record_Tools_Snap::Receive_Project_File_Selection_Status(bool status){

     this->is_project_file_selected = status;
}

void wx_Description_Record_Tools_Snap::Receive_Descriptor_File_Path(wxString File_Path){

     this->Descriptor_File_Path = File_Path;
}

void wx_Description_Record_Tools_Snap::Receive_Text_Control(wxStyledTextCtrl * Text_Ctrl){
...
void wx_Description_Record_Tools_Snap::Enter_Source_File_Location(){
...
void wx_Description_Record_Tools_Snap::Enter_Library_Location(){
...
void wx_Description_Record_Tools_Snap::Enter_Header_File(){
...
void wx_Description_Record_Tools_Snap::Enter_Header_File_Automatically(wxString Header_File_Path){
...
void wx_Description_Record_Tools_Snap::Enter_Source_File(){
...
void wx_Description_Record_Tools_Snap::Enter_Library_Name(){
...
void wx_Description_Record_Tools_Snap::Enter_Construction_Point(){
...
void wx_Description_Record_Tools_Snap::Enter_Server_Class_Name(){
...
void wx_Description_Record_Tools_Snap::Enter_Main_File_Name(){
...
void wx_Description_Record_Tools_Snap::Enter_Thread_Function_Name(){
...
void wx_Description_Record_Tools_Snap::Enter_Thread_Number(){
...
void wx_Description_Record_Tools_Snap::Enter_Exe_File_Name(){
...
void wx_Description_Record_Tools_Snap::Enter_ITC_Class_Header_File_Name(){
...
void wx_Description_Record_Tools_Snap::Enter_ITC_Class_Name(wxString ClassName){
...
void wx_Description_Record_Tools_Snap::Enter_ITC_Class_Instance_Name(wxString ClassName){
...
void wx_Description_Record_Tools_Snap::Enter_IT_Data_Type_Header_File_Name(){
...
void wx_Description_Record_Tools_Snap::Enter_IT_Data_Type_Name_Automaticly(wxString ClassName){
...
void wx_Description_Record_Tools_Snap::Enter_IT_Data_Type_Name(){
...
void wx_Description_Record_Tools_Snap::Enter_IT_Data_Type_Pointer_Name(wxString Class_Name){
...
void wx_Description_Record_Tools_Snap::Enter_Namespace(){
...
void wx_Description_Record_Tools_Snap::Enter_OpenMP_Option(bool option){
...
void wx_Description_Record_Tools_Snap::Update_Lexer_Index(){
...
void wx_Description_Record_Tools_Snap::Scroll_To_Position(){
...
void wx_Description_Record_Tools_Snap::Description_Record_Process(wxString Input_Command){
...
void wx_Description_Record_Tools_Snap::Show_Descriptor_File_Identification_Error(){
