...
#ifndef WX_DESCRIPTION_RECORD_TOOLS_SNAP_H
#define WX_DESCRIPTION_RECORD_TOOLS_SNAP_H
...
class wx_Description_Record_Tools_Snap
{
public:
  wx_Description_Record_Tools_Snap();
  virtual ~wx_Description_Record_Tools_Snap();
  void Receive_NoteBook_Manager(Custom_Notebook_Snap * Pointer);
...
#endif /* WX_DESCRIPTION_RECORD_TOOLS_SNAP_H */
