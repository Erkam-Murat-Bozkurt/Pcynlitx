...
Custom_Tree_View_Panel_Snap::Custom_Tree_View_Panel_Snap(wxFrame * frame,
...

{
     ...
     this->GetEventHandler()->Bind(wxEVT_PAINT,&Custom_Tree_View_Panel_Snap::OnPaint,this,wxID_ANY);

     this->GetEventHandler()->Bind(wxEVT_LEFT_UP,&Custom_Tree_View_Panel_Snap::mouseReleased,this,wxID_ANY);

     this->GetEventHandler()->Bind(wxEVT_SIZE,&Custom_Tree_View_Panel_Snap::Size_Event,this,wxID_ANY);
     ...
     this->Top_Bar_Window = new Custom_Window_Snap(this,wxPoint(0,0),Tab_Bar_size);
     ...
     this->close_button = new Custom_Close_Button_Snap(this->Top_Bar_Window,
...
Custom_Tree_View_Panel_Snap::~Custom_Tree_View_Panel_Snap()
{
...
void Custom_Tree_View_Panel_Snap::Size_Event(wxSizeEvent & event)
{
     event.Skip(true);
...
void Custom_Tree_View_Panel_Snap::mouseReleased(wxMouseEvent& event)
{
     event.Skip(false);
...
void Custom_Tree_View_Panel_Snap::Initialize_Sizer()
{
...
void Custom_Tree_View_Panel_Snap::Detach_Windows_From_Sizer()
{
...
void Custom_Tree_View_Panel_Snap::Receive_Topbar_MinSize(wxSize size)
{
     this->Topbar_MinSize = size;
}

void Custom_Tree_View_Panel_Snap::DrawBackground(wxDC& dc, wxWindow *  wnd, const wxRect& rect)
{
...
void Custom_Tree_View_Panel_Snap::PaintNow()
{
     wxClientDC dc(this);
...
void Custom_Tree_View_Panel_Snap::OnPaint(wxPaintEvent& event)
{
     event.Skip(true);
...
void Custom_Tree_View_Panel_Snap::Clear_Dynamic_Memory()
{
     if(!this->Memory_Delete_Condition){
...
void Custom_Tree_View_Panel_Snap::Load_Project_Directory(wxString Folder){
...
void Custom_Tree_View_Panel_Snap::Close_Directory_Pane()
{
     this->Folder_Lister->RemoveProjectDirectory();
...
void Custom_Tree_View_Panel_Snap::Set_Font(wxFont Font){

      this->tree_control->SetFont(Font);
}

Custom_wxTreeCtrl * Custom_Tree_View_Panel_Snap::GetTreeCtrl(){

     return this->tree_control;
}

wxString Custom_Tree_View_Panel_Snap::GetItemPath(wxTreeItemId item_number){

         return this->Folder_Lister->GetItemPath(item_number);
}

void Custom_Tree_View_Panel_Snap::RemoveProjectDirectory(){

     this->Folder_Lister->RemoveProjectDirectory();
}

bool Custom_Tree_View_Panel_Snap::Get_Panel_Open_Status(){
