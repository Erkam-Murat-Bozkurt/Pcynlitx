...
#ifndef CUSTOM_TREE_VIEW_PANEL_SNAP_H
#define CUSTOM_TREE_VIEW_PANEL_SNAP_H
...
class Custom_Tree_View_Panel_Snap : public wxPanel
{
public:
  Custom_Tree_View_Panel_Snap(wxFrame * parent, wxWindowID id,

       const wxPoint &pos, const wxSize &size,wxAuiManager * Interface_Manager,

       wxFont Default_Font, int tabctrl_hight);

  Custom_Tree_View_Panel_Snap(const Custom_Tree_View_Panel_Snap & orig);

  virtual ~Custom_Tree_View_Panel_Snap();
  ...
  Custom_Close_Button_Snap * close_button;

  Custom_Window_Snap * Top_Bar_Window;
...
#endif /* CUSTOM_TREE_VIEW_PANEL_SNAP_H */
