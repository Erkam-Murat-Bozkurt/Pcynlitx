...
BEGIN_EVENT_TABLE(MainFrame,wxFrame)
  ...
  EVT_MENU(ID_LOAD_LICENSE,MainFrame::ShowLicense)
  EVT_MENU(ID_OPEN_DOCUMENTATION,MainFrame::ShowHelp)
  ...
  EVT_MENU(ID_OPEN_TUTORIAL,MainFrame::Open_Tutorial)
  ...
  EVT_MENU(ID_THERMS_OF_USE,MainFrame::Show_Therms_of_use)
  EVT_MENU(ID_SHOW_DESCRIPTIONS,MainFrame::Show_Descriptions)
  EVT_SIZE(MainFrame::Size_Changed)
