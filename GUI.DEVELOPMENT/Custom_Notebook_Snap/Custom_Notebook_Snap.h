...
#ifndef CUSTOM_NOTEBOOK_SNAP_H
#define CUSTOM_NOTEBOOK_SNAP_H
...
class Custom_Notebook_Snap : public wxAuiNotebook
{
public:
  Custom_Notebook_Snap(wxPanel * parent, wxAuiManager * Interface_Manager,

         wxFont Default_Font,wxSize size);

  virtual ~Custom_Notebook_Snap();
  void Update(){};
  ...
  Custom_Notebook_Snap * Get_NoteBook_Pointer();
  ...
  Custom_TabArt_Snap * Custom_Notebook_TabArt;
