...
Custom_Notebook_Snap::Custom_Notebook_Snap( wxPanel * parent, wxAuiManager * Interface_Manager,
      ...
      : wxAuiNotebook(parent,wxID_ANY,wxDefaultPosition,size,wxAUI_NB_DEFAULT_STYLE)
{
   ...
   this->Custom_Notebook_TabArt = new Custom_TabArt_Snap();
   ...
   this->GetEventHandler()->Bind(wxEVT_SIZE,&Custom_Notebook_Snap::Size_Event,this,wxID_ANY);

   this->GetEventHandler()->Bind(wxEVT_PAINT,&Custom_Notebook_Snap::OnPaint,this,wxID_ANY);

   wxAuiNotebookEvent File_Closed(wxEVT_AUINOTEBOOK_PAGE_CLOSE,this->GetId());

   this->GetEventHandler()->Bind(wxEVT_AUINOTEBOOK_PAGE_CLOSE,&Custom_Notebook_Snap::NoteBook_Page_Closed,this,wxID_ANY);

   wxAuiNotebookEvent File_Selection_Change(wxEVT_AUINOTEBOOK_PAGE_CLOSE,this->GetId());

   this->GetEventHandler()->Bind(wxEVT_AUINOTEBOOK_PAGE_CHANGED,&Custom_Notebook_Snap::Determine_Current_Page,this,wxID_ANY);

   wxStyledTextEvent File_Change(wxEVT_STC_CHANGE,this->GetId());

   this->GetEventHandler()->Bind(wxEVT_STC_CHANGE,&Custom_Notebook_Snap::Document_Change,this,wxID_ANY);

   wxAuiNotebookEvent File_Selection_Changing(wxEVT_AUINOTEBOOK_PAGE_CHANGING,this->GetId());

   this->GetEventHandler()->Bind(wxEVT_AUINOTEBOOK_PAGE_CHANGING,&Custom_Notebook_Snap::Selection_Changing,this,wxID_ANY);
...
void Custom_Notebook_Snap::Size_Event(wxSizeEvent & event)
{
     event.Skip(true);
...
void Custom_Notebook_Snap::Initialization(){
...
Custom_Notebook_Snap::~Custom_Notebook_Snap(){
...
void Custom_Notebook_Snap::OpenIntroPage()
{
     ...
     if(!this->Is_Intro_Page_Open)
     {
         ...
         this->NoteBook_Page_Data[Index_Number].Intro_Page_Pointer =
                      ...
                      new Intro_Page_Loader_Snap(this,this->GetClientSize(),
...
void Custom_Notebook_Snap::Load_Help_Page()
{
     // Load Help Page
...
void Custom_Notebook_Snap::OnClose()
{
     this->GetEventHandler()->Unbind(wxEVT_AUINOTEBOOK_PAGE_CLOSE,&Custom_Notebook_Snap::NoteBook_Page_Closed,this,wxID_ANY);

     this->GetEventHandler()->Unbind(wxEVT_AUINOTEBOOK_PAGE_CHANGED,&Custom_Notebook_Snap::Determine_Current_Page,this,wxID_ANY);

     this->GetEventHandler()->Unbind(wxEVT_STC_CHANGE,&Custom_Notebook_Snap::Document_Change,this,wxID_ANY);

     this->GetEventHandler()->Unbind(wxEVT_AUINOTEBOOK_PAGE_CHANGING,&Custom_Notebook_Snap::Selection_Changing,this,wxID_ANY);

     this->GetEventHandler()->Unbind(wxEVT_PAINT,&Custom_Notebook_Snap::OnPaint,this,wxID_ANY);

     this->GetEventHandler()->Unbind(wxEVT_SIZE,&Custom_Notebook_Snap::Size_Event,this,wxID_ANY);
}

void Custom_Notebook_Snap::PaintNow(wxWindow * wnd)
{
     wxClientDC dc(wnd);
...
void Custom_Notebook_Snap::OnPaint(wxPaintEvent & event)
{
...
void Custom_Notebook_Snap::DrawBackground(wxDC& dc, wxWindow *  wnd, const wxRect& rect)
{
...
void Custom_Notebook_Snap::Change_Cursor_Type()
{
...
void Custom_Notebook_Snap::Load_Default_Cursor()
{
     this->Style_Change_Operation = true;
...
void Custom_Notebook_Snap::Set_Caret_Line_InVisible()
{
     this->Style_Change_Operation = true;
...
void Custom_Notebook_Snap::Set_Caret_Line_Visible()
{
     this->Style_Change_Operation = true;
...
void Custom_Notebook_Snap::Use_Default_Caret()
{
     this->Style_Change_Operation = true;
...
void Custom_Notebook_Snap::Use_Block_Caret()
{
     this->Style_Change_Operation = true;
...
void Custom_Notebook_Snap::File_Save()
{
...
void Custom_Notebook_Snap::Add_New_File(wxString File_Path)
{
...
void Custom_Notebook_Snap::Open_File(wxString File_Path)
{
     bool Is_File_Open = this->Is_File_Open(File_Path);
...
void Custom_Notebook_Snap::Set_Font(wxFont Font)
{
     this->Style_Change_Operation = true;
...
void Custom_Notebook_Snap::Set_Lexer_Style(wxFont Default_Font)
{
     this->Style_Change_Operation = true;
...
void Custom_Notebook_Snap::Set_Style_Font(wxFont Font)
{
     this->Style_Change_Operation = true;
...
void Custom_Notebook_Snap::Use_Bold_Styling()
{
     this->Style_Change_Operation = true;
...
void Custom_Notebook_Snap::Clear_Style()
{
     this->Style_Change_Operation = true;
...
void Custom_Notebook_Snap::Reload_Style()
{
     this->Style_Change_Operation = true;
...
Custom_TextCtrl * Custom_Notebook_Snap::Get_Selected_Text_Ctrl()
{
      return this->NoteBook_Page_Data[this->Current_Page_Record_Index].Text_Ctrl;
}

void Custom_Notebook_Snap::Document_Change(wxStyledTextEvent & event)
{
     event.Skip(true);
...
void Custom_Notebook_Snap::Determine_Current_Page(wxAuiNotebookEvent & event)
{
     event.Skip(true);
...
void Custom_Notebook_Snap::NoteBook_Page_Closed(wxAuiNotebookEvent & event)
{
     event.Skip(true);
...
Custom_Notebook_Snap * Custom_Notebook_Snap::Get_NoteBook_Pointer()
{
    return this;
}

int Custom_Notebook_Snap::Get_Empty_Pointer_Index_Number()
{
...
void Custom_Notebook_Snap::Determine_File_Short_Name(wxString File_Long_Name)
{
     int Name_Size = 0;
...
bool Custom_Notebook_Snap::Is_File_Open(wxString File_Path)
{
...
wxString Custom_Notebook_Snap::Get_Selected_Text_Ctrl_File_Path()
{
         return this->NoteBook_Page_Data[this->Current_Page_Record_Index].File_Path;
}

void Custom_Notebook_Snap::Select_File(wxString File_Path)
{
...
void Custom_Notebook_Snap::Selection_Changing(wxAuiNotebookEvent & event)
{
...
bool Custom_Notebook_Snap::Get_Intro_Page_Close_Condition(){

     return  this->NoteBook_Page_Data[0].Is_Page_Open;
}

int Custom_Notebook_Snap::Get_Intro_Page_Id(){

    return this->Introduction_Page_Id;
}

bool Custom_Notebook_Snap::Get_Style_Change_Condition() const
{
     return this->Style_Change_Operation;
}

int Custom_Notebook_Snap::Get_Current_Page_Index() const
{
    return this->Current_Page_Record_Index;
}

bool Custom_Notebook_Snap::Is_Current_Page_Text_File() const
{
     return this->NoteBook_Page_Data[this->Get_Current_Page_Index()].Is_This_Text_File;
}


wxString Custom_Notebook_Snap::Get_Notebook_Page_File_Path(int index)
{
