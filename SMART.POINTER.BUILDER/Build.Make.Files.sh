...
Smart_Pointer_Data_Conveyor_PATH=~/PCYNLITX.PROJECT/SMART.POINTER.BUILDER/Smart_Pointer_Data_Conveyor
...
printf "   #\e[3;36m A make file has been derived for Builder_Initializer class \e[0m\n\n"
...
printf "   #\e[3;36m A make file has been derived for ReportFileBuilder_HeaderWriter class \e[0m\n\n"
...
printf "   #\e[3;36m A make file has been derived for ReportFileBuilder_Writer class  \e[0m\n\n"
...
printf "   #\e[3;36m A make file has been derived for Dynamic_Memory_Manager_Header_Builder class \e[0m\n\n"
...
printf "   #\e[3;36m A make file has been derived for Dynamic_Memory_Manager_Builder class \e[0m\n\n"
...
printf "   #\e[3;36m A make file has been derived for Multi_Thread_Pointer_Header_Builder class \e[0m\n\n"
...
printf "   #\e[3;36m A make file has been derived for Multi_Thread_Pointer_Data_Collector class  \e[0m\n\n"
...
printf "   #\e[3;36m A make file has been derived for Multi_Thread_Pointer_Compile_Data_Collector class  \e[0m\n\n"
...
printf "   #\e[3;36m A make file has been derived for Multi_Thread_Pointer_File_Cleaner class  \e[0m\n\n"
...
printf "   #\e[3;36m A make file has been derived for Multi_Thread_Pointer_File_Data_Collector class  \e[0m\n\n"
...
printf "   #\e[3;36m A make file has been derived for Smart_Pointer_Data_Conveyor class \e[0m\n\n"
