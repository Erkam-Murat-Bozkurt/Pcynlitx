...
void Determination_of_test_command(char ** test_command, char * thread_number, char * inputFile);

int main(int argc, char ** argv){

    if(argc != 4) {

       std::cout << "\n\n   Usage: " << argv[0] << " [Repitation] [Thread Number] [Input File]" << std::endl;
    ...
    std::cout << "\n\n RODINIA LU DECOMPOSITION STD-THREAD TEST";
...
void Determination_of_test_command(char ** test_command, char * thread_number, char * inputFile){
     ...
     char exe_file [] = "rodinia_lud_std_thread";
