...
void Determine_Test_Command(char ** test_command, char * exe_file, char * the_number_of_data_point);
...
int main(int argc, char ** argv){
    ...
    if(argc != 4) {
       ...
       << " [Repitation] [Test program] [Data Points]"
    ...
    std::cout << "\n\n THE PARSEC STREAMCLUSTER PCYNLITX TEST";
...
void Determine_Test_Command(char ** test_command, char * exe_file,

                            char * the_number_of_data_point)
{
     ...
     int command_lenght = exe_file_string_lenght + the_number_of_data_point_string_length
                           ...
                           + directory_operator_string_length;
