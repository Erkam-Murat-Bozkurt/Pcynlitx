...
g++ -std=c++14 -I$INCLUDE_DIRECTORY -I$BASE_DIRECTORY -I$PCYNLITX_LIB_HEADERS \
       ...
       -o parsec_fluidanimate_pcynlitx_tn8 cellpool.cpp cellpool.hpp fluid.hpp fluidview.hpp \
       parsec_barrier.cpp parsec_barrier.hpp parsec_fluidanimate_pcynlitx_tn8.cpp data_holder.cpp \
