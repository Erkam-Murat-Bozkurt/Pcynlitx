...
void Determination_of_test_command(char ** test_command, char * exe_file, char * matrix_dim);
...
int main(int argc, char ** argv){
    ...
    if(argc != 4) {
       ...
       std::cout << "\n\n   Usage: " << argv[0] << " [Repitation] [Test program] [Matrix Dimention]" << std::endl;
    ...
    std::cout << "\n\n PCYNLITX MATRIX MULTIPLICATION TEST";
