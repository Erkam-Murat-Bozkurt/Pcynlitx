...
g++ -std=c++14 -I$INCLUDE_DIRECTORY -I$BASE_DIRECTORY -L/$BASE_DIRECTORY -o parsec_swaptions_pcynlitx_tn32 \
   ...
   HJM_SimPath_Forward_Blocking.cpp HJM.cpp HJM_Swaption_Blocking.cpp \
	 parsec_swaptions_pcynlitx_tn32.cpp -include $BASE_DIRECTORY/HJM_type.h \
