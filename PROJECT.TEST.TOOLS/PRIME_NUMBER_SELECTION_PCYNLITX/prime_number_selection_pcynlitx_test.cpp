...
void Determine_Test_Command(char ** test_command, char * test_binary, char * data_file_path);
...
int main(int argc, char ** argv){
    ...
    if(argc < 3){
       ...
       std::cout << "\n usage:" << argv[0]
                 ...
                 << " <repitation>  <test binary> <data size>";
    ...
    std::cout << "\n\n THE PCYNLITX PRIME NUMBER SELECTION TEST";
...
void Determine_Test_Command(char ** test_command, char * test_binary, char * data_size){
     ...
     int data_size_name_length = strlen(data_size);
     ...
     *test_command = new char [5*command_lenght];
     ...
     for(int i=0;i<data_size_name_length;i++){
