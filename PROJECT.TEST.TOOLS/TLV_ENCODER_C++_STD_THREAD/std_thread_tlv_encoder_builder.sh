...
g++ -o std_thread_tlv_encoder -I$PROJECT_HEADERS -I$BASE_DIR -L$PROJECT_LIBRARY \
  $BASE_DIR/std_thread_tlv_encoder.cpp $BASE_DIR/tlv_encoder.cpp $BASE_DIR/jsonreader.cpp \
...
mv std_thread_tlv_encoder $TEST_DIR
