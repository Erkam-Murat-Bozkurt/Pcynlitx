...
g++ -o jsonreader_test -I$PROJECT_HEADERS -I$BASE_DIR -L$PROJECT_LIBRARY \
  $TEST_PROGRAMS/jsonreader_test.cpp $BASE_DIR/jsonreader.cpp \
  $BASE_DIR/string_reader.cpp $BASE_DIR/data_extracter.cpp \
   ...
   -include IntToCharTranslater.h -lpthread -lmptools
