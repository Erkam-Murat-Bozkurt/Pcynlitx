...
#include "HJM.h"
#include "parsec_swaptions_std_thread.h"
#include "HJM_type.h"
#include <thread>
#include <sys/time.h>
...
int main(int argc, char *argv[])
{
    ...
    if(argc != 4)
    {
       std::cout << "\n\n   Usage: " << argv[0] << "  [Number of Thread] [Number of swaptions] [Number of simulations]" << std::endl;
     ...
     nSwaptions = atoi(argv[2]); // Number of swaptions

     NUM_TRIALS = atoi(argv[3]); // Number of simulations
