...
Synchronizer_Client_Header_Builder::Synchronizer_Client_Header_Builder(){
...
Synchronizer_Client_Header_Builder::Synchronizer_Client_Header_Builder(const Synchronizer_Client_Header_Builder & orig){
...
void Synchronizer_Client_Header_Builder::Clear_Dynamic_Memory(){
...
void Synchronizer_Client_Header_Builder::Clear_Pointer_Memory(char ** Pointer){
...
void Synchronizer_Client_Header_Builder::Receive_Process_Supervisor_Descriptor_File_Reader(Process_Supervisor_Descriptor_File_Reader * Pointer){
...
char Synchronizer_Client_Header_Builder::ConvertToUpper(char character){
...
void Synchronizer_Client_Header_Builder::Determine_Inclusion_Word(){

     char Class_Name [ ] = {'S','y','n','c','h','r','o','n','i','z','e','r','_','C','l','i','e','n','t','\0'};
...
void Synchronizer_Client_Header_Builder::Move_Header_File(){
...
void Synchronizer_Client_Header_Builder::Build_Header_File(){
     ...
     this->File_Manager.SetFilePath("Synchronizer_Client.h");
     ...
     this->File_Manager.WriteToFile("class Synchronizer_Client {");

     this->File_Manager.WriteToFile("\npublic:");

     this->File_Manager.WriteToFile("\n  Synchronizer_Client(thds * data_str, std::string Thread_Function_Name);");

     this->File_Manager.WriteToFile("\n  Synchronizer_Client(const Synchronizer_Client & orig);");

     this->File_Manager.WriteToFile("\n  virtual ~Synchronizer_Client();");
     ...
     this->File_Manager.WriteToFile("\n  ThreadSynchronization * Connection_Pointer;");
...
void Synchronizer_Client_Header_Builder::Place_Information(char ** Pointer, char * Information, int * counter){
