...
Process_Supervisor_Header_File_Builder::Process_Supervisor_Header_File_Builder(){
...
Process_Supervisor_Header_File_Builder::Process_Supervisor_Header_File_Builder(const Process_Supervisor_Header_File_Builder & orig){
...
void Process_Supervisor_Header_File_Builder::Clear_Dynamic_Memory(){
...
void Process_Supervisor_Header_File_Builder::Determine_Inclusion_Word(){
...
char Process_Supervisor_Header_File_Builder::ConvertToUpper(char character){
...
void Process_Supervisor_Header_File_Builder::Receive_Process_Descriptor_File_Reader(Process_Supervisor_Descriptor_File_Reader * Pointer){
...
void Process_Supervisor_Header_File_Builder::Build_Supervisor_Header_File(){
     ...
     this->FileManager.WriteToFile("\n  ThreadSynchronization Synchronizer;");
...
void Process_Supervisor_Header_File_Builder::Move_Header_File(){
...
void Process_Supervisor_Header_File_Builder::Place_Information(char ** Pointer, char * Information, int * counter){
