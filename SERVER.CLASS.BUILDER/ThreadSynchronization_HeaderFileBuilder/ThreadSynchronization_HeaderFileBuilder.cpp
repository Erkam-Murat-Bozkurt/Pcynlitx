...
ThreadSynchronization_HeaderFileBuilder::ThreadSynchronization_HeaderFileBuilder(){

};

ThreadSynchronization_HeaderFileBuilder::ThreadSynchronization_HeaderFileBuilder(const ThreadSynchronization_HeaderFileBuilder & orig){
...
void ThreadSynchronization_HeaderFileBuilder::Receive_Process_Supervisor_Descriptor_File_Reader(Process_Supervisor_Descriptor_File_Reader * Pointer){

     this->Reader_Pointer = Pointer;
}

void ThreadSynchronization_HeaderFileBuilder::Build_ThreadSynchronization_Header_File(){
     ...
     this->FileManager.SetFilePath("ThreadSynchronization.h");
     ...
     this->FileManager.WriteToFile("\n  ThreadSynchronization(const ThreadSynchronization & orig);");
