...
*/
 ...
 Process_Supervisor_Descriptor_File_Reader::Process_Supervisor_Descriptor_File_Reader(){
 ...
 Process_Supervisor_Descriptor_File_Reader::Process_Supervisor_Descriptor_File_Reader(const Process_Supervisor_Descriptor_File_Reader & orig){
 ...
 void Process_Supervisor_Descriptor_File_Reader::Clear_Dynamic_Memory(){

      if(!this->Memory_Delete_Condition){

          this->Memory_Delete_Condition = true;

          if(this->Newly_Constructed_Include_Directory != nullptr){

             delete [] this->Newly_Constructed_Include_Directory;
          }
 ...
 void Process_Supervisor_Descriptor_File_Reader::Receive_Descriptor_File_Directory(const char * DescriptorFileDirectory){

      this->File_Data_Collector.Receive_Descriptor_File_Directory(DescriptorFileDirectory);
 }

 void Process_Supervisor_Descriptor_File_Reader::Receive_Descriptor_File_Directory(char * DescriptorFileDirectory){

      this->File_Data_Collector.Receive_Descriptor_File_Directory(DescriptorFileDirectory);
 }

 void Process_Supervisor_Descriptor_File_Reader::Receive_Descriptor_File_Name(const char * DescriptorFileName){

      this->File_Data_Collector.Receive_Descriptor_File_Name(DescriptorFileName);
 }

 void Process_Supervisor_Descriptor_File_Reader::Receive_Descriptor_File_Name(char * DescriptorFileName){

      this->File_Data_Collector.Receive_Descriptor_File_Name(DescriptorFileName);
 }

 void Process_Supervisor_Descriptor_File_Reader::Receive_Descriptor_File_Infomations(){
 ...
 void Process_Supervisor_Descriptor_File_Reader::Receive_Include_Directory_Descriptions(){
 ...
 void Process_Supervisor_Descriptor_File_Reader::Receive_Inter_Thread_Class_Names(){
...
void Process_Supervisor_Descriptor_File_Reader::Receive_Shared_Memory_Data_Types(){
...
void Process_Supervisor_Descriptor_File_Reader::Receive_Source_File_Descriptions(){
...
void Process_Supervisor_Descriptor_File_Reader::Receive_Header_File_Descriptions(){
...
void Process_Supervisor_Descriptor_File_Reader::Receive_Library_Descriptions(){
...
void Process_Supervisor_Descriptor_File_Reader::Receive_Main_File_Descriptions(){
...
void Process_Supervisor_Descriptor_File_Reader::Control_Process_Header_Files_Syntax(){
...
void Process_Supervisor_Descriptor_File_Reader::Remove_Compiler_Output_File(){
...
void Process_Supervisor_Descriptor_File_Reader::Determine_Newly_Constructed_Include_Directory(){
     ...
     this->Newly_Constructed_Include_Directory = new char [10*Newly_Constructed_Include_Directory_Name_Size];

     int index_counter = 0;

     for(int i=0;i<Construction_Point_Name_Size;i++){

         this->Newly_Constructed_Include_Directory[index_counter] = this->Get_Construction_Point()[i];

         index_counter++;
     }

     this->Newly_Constructed_Include_Directory[index_counter] = '/';

     index_counter++;

     for(int i=0;i<Server_Class_Name_Size;i++){

         this->Newly_Constructed_Include_Directory[index_counter] = this->Get_Server_Class_Name()[i];
     ...
     for(int i=0;i<Include_Directory_Add_Word_Name_Size;i++){
         ...
         this->Newly_Constructed_Include_Directory[index_counter] = Include_Directory_Add_Word[i];

         index_counter++;
     }

     this->Newly_Constructed_Include_Directory[index_counter] = '\0';
}

Class_Data_Type * Process_Supervisor_Descriptor_File_Reader::Get_Class_Names(){

        return this->IT_Class_Reader.Get_Class_Names();
}

Include_Directory_Type * Process_Supervisor_Descriptor_File_Reader::Get_Include_Directory(){

       return this->ID_Description_Reader.Get_Include_Directory();
}

Shared_Memory_Data_Type * Process_Supervisor_Descriptor_File_Reader::Get_Shared_Data_Types(){

       return this->IT_Data_Type_Reader.Get_Shared_Data_Types();
}

char * Process_Supervisor_Descriptor_File_Reader::Get_Main_File_Name(){

       return this->MF_Descriptions_Reader.Get_Main_File_Name();
}

char * Process_Supervisor_Descriptor_File_Reader::Get_Executable_File_Name(){

       return this->MF_Descriptions_Reader.Get_Executable_File_Name();
}

char * Process_Supervisor_Descriptor_File_Reader::Get_Server_Class_Name(){

       return this->MF_Descriptions_Reader.Get_Server_Class_Name();
}

char * Process_Supervisor_Descriptor_File_Reader::Get_Server_Class_Header_File_Name(){

       return this->MF_Descriptions_Reader.Get_Server_Class_Header_File_Name();
}

char * Process_Supervisor_Descriptor_File_Reader::Get_Construction_Point(){

       return this->MF_Descriptions_Reader.Get_Construction_Point();
}

char * Process_Supervisor_Descriptor_File_Reader::Get_Newly_Constructed_Include_Directory(){

       return this->Newly_Constructed_Include_Directory;
}

char ** Process_Supervisor_Descriptor_File_Reader::Get_Source_File_Locations(){

        return this->SF_Descriptions_Reader.Get_Source_File_Locations();
}

char ** Process_Supervisor_Descriptor_File_Reader::Get_Source_File_Names(){

        return this->SF_Descriptions_Reader.Get_Source_File_Names();
}

char ** Process_Supervisor_Descriptor_File_Reader::Get_Header_File_Names(){

        return this->HF_Descriptions_Reader.Get_Header_File_Names();
}

char ** Process_Supervisor_Descriptor_File_Reader::Get_Header_File_Paths(){

        return this->HF_Descriptions_Reader.Get_Header_File_Paths();
}

char ** Process_Supervisor_Descriptor_File_Reader::Get_Thread_Function_Names(){

        return this->MF_Descriptions_Reader.Get_Thread_Function_Names();
}

char ** Process_Supervisor_Descriptor_File_Reader::Get_Library_Directories(){

        return this->Lib_Descriptions_Reader.Get_Library_Directories();
}

char ** Process_Supervisor_Descriptor_File_Reader::Get_Library_Names(){

        return this->Lib_Descriptions_Reader.Get_Library_Names();
}

int Process_Supervisor_Descriptor_File_Reader::Get_Thread_Number(){

    return this->MF_Descriptions_Reader.Get_Thread_Number();
}

int Process_Supervisor_Descriptor_File_Reader::Get_Class_Number(){

     return this->IT_Class_Reader.Get_Class_Number();
}

int Process_Supervisor_Descriptor_File_Reader::Get_Thread_Function_Number(){

    return this->MF_Descriptions_Reader.Get_Thread_Function_Number();
}

int Process_Supervisor_Descriptor_File_Reader::Get_Header_Files_Number(){

    return this->HF_Descriptions_Reader.Get_Header_Files_Number();
}

int Process_Supervisor_Descriptor_File_Reader::Get_Shared_Data_Types_Number(){

    return this->IT_Data_Type_Reader.Get_Shared_Data_Types_Number();
}

int Process_Supervisor_Descriptor_File_Reader::Get_Source_File_Location_Number(){

    return this->SF_Descriptions_Reader.Get_Source_File_Location_Number();
}

int Process_Supervisor_Descriptor_File_Reader::Get_Source_File_Names_Number(){

    return this->SF_Descriptions_Reader.Get_Source_File_Names_Number();
}

int Process_Supervisor_Descriptor_File_Reader::Get_Shared_Data_Types_Include_File_Names_Number(){

    return this->IT_Data_Type_Reader.Get_Shared_Data_Types_Include_File_Names_Number();
}

int Process_Supervisor_Descriptor_File_Reader::Get_Include_Directory_Number(){

    return this->ID_Description_Reader.Get_Include_Directory_Number();
}

int Process_Supervisor_Descriptor_File_Reader::Get_Library_Directory_Number(){

    return this->Lib_Descriptions_Reader.Get_Library_Directory_Number();
}

int Process_Supervisor_Descriptor_File_Reader::Get_Library_Names_Number(){
