...
#ifndef PROCESS_SUPERVISOR_DESCRIPTOR_FILE_READER_H
#define PROCESS_SUPERVISOR_DESCRIPTOR_FILE_READER_H
...
class Process_Supervisor_Descriptor_File_Reader
{
public:
 Process_Supervisor_Descriptor_File_Reader();
 Process_Supervisor_Descriptor_File_Reader(const Process_Supervisor_Descriptor_File_Reader & orig);
 virtual ~Process_Supervisor_Descriptor_File_Reader();
 ...
 char *  Get_Newly_Constructed_Include_Directory();
...
#endif /* PROCESS_SUPERVISOR_DESCRIPTOR_FILE_READER_H */
