...
void Inter_Thread_Class_Description_Reader::Receive_Data_Collector(Process_Supervisor_Descriptor_File_Data_Collector * Pointer){

     this->Data_Collector_Pointer = Pointer;
}

void Inter_Thread_Class_Description_Reader::Receive_Initializer(Process_Supervisor_Descriptor_File_Reader_Initializer * Pointer){

     this->Initializer_Pointer = Pointer;
}

void Inter_Thread_Class_Description_Reader::Receive_Number_Processor(Process_Supervisor_Descriptor_File_Number_Processor * Pointer){
