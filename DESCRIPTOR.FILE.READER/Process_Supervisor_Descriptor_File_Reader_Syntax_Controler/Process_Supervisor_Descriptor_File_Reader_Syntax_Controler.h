...
#ifndef PROCESS_SUPERVISOR_DESCRIPTOR_FILE_READER_SYNTAX_CONTROLER_H
#define PROCESS_SUPERVISOR_DESCRIPTOR_FILE_READER_SYNTAX_CONTROLER_H
...
class Process_Supervisor_Descriptor_File_Reader_Syntax_Controler
{
public:
  Process_Supervisor_Descriptor_File_Reader_Syntax_Controler();
  Process_Supervisor_Descriptor_File_Reader_Syntax_Controler(const Process_Supervisor_Descriptor_File_Reader_Syntax_Controler & orig);
  virtual ~Process_Supervisor_Descriptor_File_Reader_Syntax_Controler();
