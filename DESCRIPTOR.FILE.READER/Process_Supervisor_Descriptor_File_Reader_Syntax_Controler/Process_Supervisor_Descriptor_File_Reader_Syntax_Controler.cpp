...
Process_Supervisor_Descriptor_File_Reader_Syntax_Controler::Process_Supervisor_Descriptor_File_Reader_Syntax_Controler(){
...
Process_Supervisor_Descriptor_File_Reader_Syntax_Controler::Process_Supervisor_Descriptor_File_Reader_Syntax_Controler(const Process_Supervisor_Descriptor_File_Reader_Syntax_Controler & orig){
...
void Process_Supervisor_Descriptor_File_Reader_Syntax_Controler::Clear_Dynamic_Memory(){
...
void Process_Supervisor_Descriptor_File_Reader_Syntax_Controler::Receive_Construction_Point(char * Construction_Point){

     this->Construction_Point = Construction_Point;
}

void Process_Supervisor_Descriptor_File_Reader_Syntax_Controler::Determine_Class_Data_Type_Receive_Condition(bool condition){

     this->Class_Data_Type_Receive_Condition = condition;
}

void Process_Supervisor_Descriptor_File_Reader_Syntax_Controler::Determine_Shared_Data_Type_Receive_Condition(bool condition){

     this->Shared_Data_Type_Receive_Condition = condition;
}

void Process_Supervisor_Descriptor_File_Reader_Syntax_Controler::Receive_Inter_Thread_Class_Data(Class_Data_Type * Data){

     this->Class_Data_Type_Holder = Data;
}

void Process_Supervisor_Descriptor_File_Reader_Syntax_Controler::Receive_Inter_Thread_Data_Type_Data(Shared_Memory_Data_Type * Data){

     this->Shared_Memory_Data_Type_Holder = Data;
}

void Process_Supervisor_Descriptor_File_Reader_Syntax_Controler::Control_Process_Syntax(){
...
void Process_Supervisor_Descriptor_File_Reader_Syntax_Controler::Determine_Inter_Thread_Class_Informations(Class_Data_Type Class_Data_Holder){
...
void Process_Supervisor_Descriptor_File_Reader_Syntax_Controler::Determine_Shared_Data_Type_Informations(Shared_Memory_Data_Type Data_Holder){
...
void Process_Supervisor_Descriptor_File_Reader_Syntax_Controler::Place_String(char ** Pointer, char * String, int String_Size){
...
void Process_Supervisor_Descriptor_File_Reader_Syntax_Controler::Place_Information(char ** Pointer, char * Information, int * index_counter){
