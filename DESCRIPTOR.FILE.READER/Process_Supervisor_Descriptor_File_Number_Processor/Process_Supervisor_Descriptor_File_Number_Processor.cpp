...
Process_Supervisor_Descriptor_File_Number_Processor::Process_Supervisor_Descriptor_File_Number_Processor(){

     this->Memory_Delete_Condition = false;
}

Process_Supervisor_Descriptor_File_Number_Processor::Process_Supervisor_Descriptor_File_Number_Processor(const Process_Supervisor_Descriptor_File_Number_Processor & orig){
...
void Process_Supervisor_Descriptor_File_Number_Processor::Clear_Dynamic_Memory(){
...
int Process_Supervisor_Descriptor_File_Number_Processor::Read_Record_Number_From_String_Line(char * String){
...
int Process_Supervisor_Descriptor_File_Number_Processor::Read_Second_Record_Number_From_String_Line(char * String){
...
int Process_Supervisor_Descriptor_File_Number_Processor::Get_Read_Operation_Start_Point(char * String){
...
void Process_Supervisor_Descriptor_File_Number_Processor::Set_Zero_For_Integer_List(int ** list, int list_size){
...
bool Process_Supervisor_Descriptor_File_Number_Processor::Check_Number_Repitation(int * list, int list_size){
