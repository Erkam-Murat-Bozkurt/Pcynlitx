...
cd ~/PCYNLITX.PROJECT/PACKAGE.MANAGEMENT.TOOLS

./Build_GUI_Make_File_Header

cd ~/PCYNLITX.PROJECT/PACKAGE.MANAGEMENT.TOOLS/Auto_Class_Compiler

bash Build_Class_Compiler.sh

cd ~/PCYNLITX.PROJECT/PACKAGE.MANAGEMENT.TOOLS/Test_Program_Builder
...
cd ~/PCYNLITX.PROJECT/PACKAGE.MANAGEMENT.TOOLS/Library_Updater

bash Build_Library_Updater.sh

cd ~/PCYNLITX.PROJECT/PACKAGE.MANAGEMENT.TOOLS/Make_File_Builder

bash Build_Make_File_Builder.sh

cd ~/PCYNLITX.PROJECT/PACKAGE.MANAGEMENT.TOOLS/Modification_Control_Script_Builder
