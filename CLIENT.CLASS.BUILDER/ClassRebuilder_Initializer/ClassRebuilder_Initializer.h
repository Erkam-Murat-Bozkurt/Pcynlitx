...
public:
 ...
 int  Get_Index_Number_For_Descriptor_File_Reader();
 char * Get_Object_Name();
 char * Get_New_Header_File_Name();
 char * Get_New_Class_Name();
 char * Get_New_Class_Implementation_File_Name();
 char * Get_New_Class_Constructor_Name();
 char * Get_New_Class_Destructor_Name();
 char * Get_Base_Class_Destructor_Name();
 char * Get_Base_Class_Header_File_Name();
 char * Get_Base_Class_Header_File_Path();
 char * Get_Base_Class_Name();
 char * Get_Base_Class_Header_File_Location();
 char * Get_Base_Class_Instance_Name();
private:
