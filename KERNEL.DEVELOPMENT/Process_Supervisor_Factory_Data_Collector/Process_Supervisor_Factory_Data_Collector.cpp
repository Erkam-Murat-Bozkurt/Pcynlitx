...
Process_Supervisor_Factory_Data_Collector::Process_Supervisor_Factory_Data_Collector(){
...
Process_Supervisor_Factory_Data_Collector::Process_Supervisor_Factory_Data_Collector(const Process_Supervisor_Factory_Data_Collector & orig){
...
void Process_Supervisor_Factory_Data_Collector::Clear_Dynamic_Memory(){
...
void Process_Supervisor_Factory_Data_Collector::Clear_Pointer_Memory(char ** Pointer){
...
void Process_Supervisor_Factory_Data_Collector::Receive_Process_Supervisor_Descriptor_File_Reader(Process_Supervisor_Descriptor_File_Reader * Pointer){

     this->Reader_Pointer = Pointer;
}

void Process_Supervisor_Factory_Data_Collector::Remove_Object_Files(){

     this->Memory_Delete_Condition = false;

     char Syncronizer_Class_Name [] = "ThreadSynchronization";

     char Syncronizer_Client_Class_Name [] = "Synchronizer_Client";
...
void Process_Supervisor_Factory_Data_Collector::Construct_New_Library(){
...
void Process_Supervisor_Factory_Data_Collector::Determine_Object_File_List(){
...
void Process_Supervisor_Factory_Data_Collector::Construct_New_Include_Directory(){

     this->Memory_Delete_Condition = false;

     this->New_Include_Directory_Name = this->Reader_Pointer->Get_Newly_Constructed_Include_Directory();
...
void Process_Supervisor_Factory_Data_Collector::Jump_To_Construction_Point(){
...
void Process_Supervisor_Factory_Data_Collector::Place_String(char ** Pointer,char * String, int String_Size){
...
void Process_Supervisor_Factory_Data_Collector::Place_Information(char ** Pointer, char * Information, int * counter){
...
char * Process_Supervisor_Factory_Data_Collector::Get_New_Include_Directory_Name(){
